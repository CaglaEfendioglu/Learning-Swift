...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let y6 = Yemekler(yemekId: 6, yemekAdi: "Kadayif", yemekResimAdi: "kadayif", yemekFiyat: 16.0)
        let y7 = Yemekler(yemekId: 7, yemekAdi: "Kahve", yemekResimAdi: "kahve", yemekFiyat: 6.0)
        let y8 = Yemekler(yemekId: 8, yemekAdi: "Kofte", yemekResimAdi: "kofte", yemekFiyat: 15.0)
        ...
        let y13 = Yemekler(yemekId: 13, yemekAdi: "Sutlac", yemekResimAdi: "sutlac", yemekFiyat: 10.0)
...
extension ViewController: UITableViewDelegate, UITableViewDataSource,YemekTableViewCellProtocol{
    func siparisVer(indexPath: IndexPath) {
        ...
        print("\(gelenYemek.yemekAdi!) siparis verildi. Kazanc: \(gelenYemek.yemekFiyat!)")
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.labelYemekFiyat.text = "\(gelenYemek.yemekFiyat!) ₺"
